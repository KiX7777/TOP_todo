...
parcelHelpers.export(exports, "lists", ()=>lists);
...
class Task {
    constructor(title, description, dueDate, priority, notes, list){
        this.title = title, this.description = description, this.dueDate = new Date(dueDate).toLocaleString("hr-HR"), this.priority = priority, this.notes = notes;
        this.isDone = false;
        this.list = list;
    }
    doTask() {
...
function load() {
    if (localStorage.getItem("Lists") === null) {
        ...
        (0, _viewJsDefault.default).createListCard(novaLista);
        (0, _controllerJsDefault.default).saveLocal();
        init();
    } else {
        ...
        lists.forEach((list)=>{
            ...
            console.log(lists);
            (0, _viewJsDefault.default).hideListPopup();
            (0, _viewJsDefault.default).createListCard(novaLista);
            ...
            lista.tasks.forEach((task)=>{
                console.log(task);
                (0, _viewJsDefault.default).createTaskCard(task);
            });
            //DEFAULT SE UČITAVA
        ...
        // });
        init();
        (0, _viewJsDefault.default).toggleTaskLists();
        (0, _viewJsDefault.default).removeCard("listsContainer", lists);
        (0, _viewJsDefault.default).removeCard("taskContainer", lists);
        (0, _viewJsDefault.default).doTask("taskContainer", lists);
        (0, _viewJsDefault.default).editTask("taskCard", lists);
    }
}
// ALLOW CREATING TASK
function startTask() {
    ...
    createTaskModal.forEach((button)=>{
        button.addEventListener("click", (e)=>{
            ...
            (0, _viewJsDefault.default).createTaskPopup();
            (0, _controllerJsDefault.default).addTask();
        });
    });
}
// START APP
function init() {
    (0, _viewJsDefault.default).showSidebar();
    (0, _controllerJsDefault.default).startCreatingList();
    (0, _controllerJsDefault.default).addTask();
    (0, _controllerJsDefault.default).addList();
    startTask();
}
load();

},{"./controller.js":"gCE4p","./view.js":"ai2uB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gCE4p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Controller {
    ...
    createTask = (list)=>{
        ...
        if (!taskTitle || (taskTitle.trim().length, false)) {
            ...
            let date = (0, _dateFns.format)(new Date(duedate.value), "dd/MM/yyyy");
            console.log(date);
            let taskPriority = priority2.value;
            if (taskPriority === "normal" || taskPriority === "important") {
                let taskNotes = notes.value;
                return new (0, _appJs.Task)(taskTitle, taskDescription, taskdueDate, taskPriority, taskNotes, list);
            } else {
    ...
    addTask() {
        ...
        close.addEventListener("click", (e)=>{
            e.preventDefault();
            (0, _viewJsDefault.default).hideTaskPopup();
            (0, _viewJsDefault.default).resetForm("popupmodal");
        });
        const closeedit = document.querySelector(".closeeditmodalimg");
        closeedit.addEventListener("click", (e)=>{
            e.preventDefault();
            (0, _viewJsDefault.default).hideEditPopup();
            (0, _viewJsDefault.default).resetForm("editmodal");
        });
        ...
        overlay.addEventListener("click", ()=>{
            ...
            (0, _viewJsDefault.default).hideListPopup();
            (0, _viewJsDefault.default).resetForm("popupmodal");
            (0, _viewJsDefault.default).resetForm("listModal");
        });
        confirmTaskCreation.addEventListener("click", (e)=>{
            ...
            let lista = (0, _appJs.lists).find((item)=>item.title === idAktivnog);
            let index = (0, _appJs.lists).indexOf(lista);
            let todo = this.createTask(idAktivnog);
            if (todo === undefined) return;
            else (0, _appJs.lists)[index].tasks.push(todo);
            (0, _viewJsDefault.default).hideTaskPopup();
            (0, _viewJsDefault.default).resetForm("popupmodal");
            (0, _viewJsDefault.default).createTaskCard(todo);
            (0, _viewJsDefault.default).removeCard("taskContainer", (0, _appJs.lists));
            (0, _viewJsDefault.default).doTask("taskContainer", (0, _appJs.lists));
            (0, _viewJsDefault.default).editTask("taskCard", (0, _appJs.lists));
            (0, _viewJsDefault.default).resetForm("editmodal");
            this.saveLocal();
        });
    }
    ...
    createList() {
        ...
        if (!naziv || naziv.trim().length === 0) {
            ...
            if ((0, _appJs.lists).find((item)=>item.title === naziv)) {
                alert("List with that name already exists! Choose another name.");
                return;
            } else return new (0, _appJs.List)(naziv);
        }
    ...
    addList() {
        confirmListCreation.addEventListener("click", (e)=>{
            ...
            if (typeof novaLista !== "object") return;
                ...
                (0, _appJs.lists).push(novaLista);
                (0, _viewJsDefault.default).hideListPopup();
                (0, _viewJsDefault.default).createListCard(novaLista);
                (0, _viewJsDefault.default).resetForm("listModal");
                (0, _viewJsDefault.default).removeCard("listsContainer", (0, _appJs.lists));
                (0, _viewJsDefault.default).toggleTaskLists();
                (0, _viewJsDefault.default).showSidebar();
                this.saveLocal();
                const createTaskModal = document.querySelectorAll(".createTaskModal");
    ...
    startCreatingList() {
        createListModal.addEventListener("click", ()=>{
            (0, _viewJsDefault.default).createListPopup();
            (0, _viewJsDefault.default).containerColor();
    ...
    saveLocal() {
        localStorage.setItem("Lists", JSON.stringify((0, _appJs.lists)));
    }
}
exports.default = new Controller();

},{"./app.js":"bNKaB","./view.js":"ai2uB","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ai2uB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _appJs = require("./app.js");
var _controllerJs = require("./controller.js");
...
class View {
  ...
  >
    ...
    createTaskPopup() {
        if ((0, _appJs.lists).length < 1) return;
        else {
            overlay.style.display = "block";
    ...
    createListCard(list) {
        ...
        card.classList = "card listCard";
        if (list.title !== "Default") card.innerHTML = ` <p class="title">${list.title}</p>   <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
    stroke-width="1.5"
  ...
  >
    ...
    />
        ...
        else card.innerHTML = ` <p class="title">${list.title}</p> 
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"
      />
        ...
        if (document.querySelector(".taskContainer")) document.querySelectorAll(".taskContainer").forEach((container)=>{
            container.style.display = "none";
            container.classList.remove("active");
        });
        listContainer.appendChild(card);
        ...
        let taskcontainer = document.createElement("div");
        taskcontainer.classList = `taskContainer ${list.title.replaceAll(" ", "")} active`;
        taskcontainer.innerHTML = `
  ...
  >
        ...
        cont.forEach((container)=>{
            container.querySelectorAll(".finishCardBtn").forEach((button)=>{
                button.addEventListener("click", (e)=>{
                    ...
                    const deleteTask = lists[listIndex].tasks.find((item)=>item.title === taskname.trim());
        ...
        buttonCont.forEach((container)=>{
            container.querySelectorAll(".deleteCardbtn").forEach((btn)=>{
                btn.addEventListener("click", (e)=>{
                    ...
                    let title1 = cardToDelete.querySelector(".title").textContent;
                    let containertoDelete = document.querySelector(`.${title1}`);
                    // IF LIST IS TO BE REMOVED
                    if (cardToDelete.classList.contains("listCard")) {
                        let correctList = lists.find((item)=>item.title === title1.trim());
                        ...
                        if (listIndex === -1) return;
                            ...
                            (0, _controllerJsDefault.default).saveLocal();
                            if (lists.length < 1) localStorage.removeItem("Lists");
                    ...
                    //IF TASK IS TO BE REMOVED
                        ...
                        let selectedList = lists.find((item)=>item.title === imeListe);
                        let listIndex1 = lists.indexOf(selectedList);
                        let findTask = lists[listIndex1].tasks.find((task)=>task.title === title1.trim());
                        let taskindex = lists[listIndex1].tasks.indexOf(findTask);
                        lists[listIndex1].tasks.splice(taskindex, 1);
                        (0, _controllerJsDefault.default).saveLocal();
                        if (lists.length < 1) localStorage.removeItem("Lists");
                    }
                });
    ...
    createTaskCard(task) {
        let card = document.createElement("div");
        const taskContainer = document.querySelector(`.${task.list.replaceAll(" ", "")}`);
        if (task.priority === "important") card.classList = "taskCard card importantCard";
        else card.classList = "taskCard card";
        card.dataset.listId = task.list;
        let shortDate = task.dueDate.slice(0, 13);
        card.innerHTML = `
                      <span class="taskCardinfo title">${task.title.trim()}</span>
                      ${task.priority === "important" ? `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 important">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                        </svg>
                        ` : ""}
                      <span class="taskCardinfo description">${task.description}</span>
...
`;
    ...
    toggleTaskLists() {
        ...
        list.forEach((card)=>card.addEventListener("click", (e)=>{
                e.preventDefault();
                e.stopImmediatePropagation();
                let naziv;
                if (e.target.className === "title") {
                    naziv = e.target.textContent.trim();
                    let container = document.querySelector(`.taskContainer.${naziv.replaceAll(" ", "")}`);
                    document.querySelectorAll(".taskContainer").forEach((container)=>{
                        container.style.display = "none";
                        container.classList.remove("active");
                    });
                    ...
                    let correctList = (0, _appJs.lists).find((item)=>item.title === naziv.trim());
                    let listIndex = (0, _appJs.lists).indexOf(correctList);
                    let color = (0, _appJs.lists)[listIndex].color;
                    container.style.display = "flex";
                    container.classList.add("active");
                    container.style.backgroundColor = color;
                } else {
                    naziv = e.target.querySelector(`.title`).textContent;
                    let container1 = document.querySelector(`.taskContainer.${naziv.replaceAll(" ", "")}`);
                    document.querySelectorAll(".taskContainer").forEach((container)=>{
                        container.style.display = "none";
                        container.classList.remove("active");
                        container.classList.add(".swing-top-fwd");
                    });
                    let correctList1 = (0, _appJs.lists).find((item)=>item.title === naziv.trim());
                    let listIndex1 = (0, _appJs.lists).indexOf(correctList1);
                    let color1 = (0, _appJs.lists)[listIndex1].color;
        ...
        cont.forEach((taskCard)=>{
            ...
            taskCard.querySelectorAll(".editCardBtn").forEach((button)=>{
                button.addEventListener("click", (e)=>{
                    ...
                    escape.addEventListener("keydown", (e)=>{
                        if (e.key === "Escape") this.hideEditPopup();
                    });
                    savebtn.addEventListener("click", (e)=>{
                        ...
                        let selectedList = lists.find((item)=>item.title === imeListe);
                        let listIndex = lists.indexOf(selectedList);
                        const editTask = lists[listIndex].tasks.find((item)=>item.title === taskname.textContent.trim());
...
},{"./app.js":"bNKaB","./controller.js":"gCE4p","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire5b66")
